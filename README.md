...
TIU:
  ...
  SAVE_TOKEN_FILE_NAME: './log/user_token.json'  #session-id along with other informatin is stored in this file.


DIU:
  ...
  TOKEN_FILE: './log/user_token.json'   #if DIU and TIU are using same session, then give session file generated by the TIU
  CRED_FILE: './data/cred/user_cred.yml' 
  ...
