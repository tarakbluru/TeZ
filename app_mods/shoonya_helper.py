    ...
    def __init__(self, dl_file:bool=True, use_file:bool=True, 
        ...
        def download_unzip_symbols_file(url, folder, srcfile, dstfile):
            ...
            try:
                ...
                logger.debug (f'requests Timeout exception occured')
            except Exception as e:
                ...
                with zipfile.ZipFile(io.BytesIO(data)) as zip_ref:
                    logger.debug (f'extracting the zip file')
        ...
        logger.info (f'Creating Shoonya Object..')
                    ...
                    if evt_flag:
                        ...
                        if exit_evt.is_set (): 
                            ...
                            if self.m_open <= datetime.now () < self.m_close:
                                ...
                                re_connect = True
                                break
                if exit == False and re_connect == True:
